...
namespace Genspil
{
    public static class PseudoDatabase
    {
        ...
        public static void DatabaseSeeder()
        {
            ...
            gametypes.Add(new GameType(Name: "Monopoly", Description: "", MinAge: 8, minPlayers: 4, maxPlayers: 6, genre: Genre.Familygame));
            gametypes.Add(new GameType(Name: "Ludo", Description: "", MinAge: 4, minPlayers: 2, maxPlayers: 4, genre: Genre.Familygame));

            games.Add(new Game(id: 1, price: 50.00, gametype: gametypes[0], condition: Condition.Fine));
            games.Add(new Game(id: 2, price: 75.00, gametype: gametypes[0], condition: Condition.Perfect));
